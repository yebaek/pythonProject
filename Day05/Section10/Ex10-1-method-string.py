...
print("10자리 폭 왼 쪽 정령'{:<10d}'".format(123))
print("10자리 폭 오른쪽 정령'{:>10d}'".format(123))
print("10자리 폭 가운데 정령'{:^10d}'".format(123))
print()
print("10자리 폭 왼 쪽 정령 채움문자'{:*<10d}'".format(123))
print("10자리 폭 오른쪽 정령 채움문자'{:*>10d}'".format(123))
print("10자리 폭 가운데 정령 채움문자'{:*^10d}'".format(123))
